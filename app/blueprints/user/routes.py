...
def crop_prices():
    try:
        ...
        if duration == "week":   
            current_duration = datetime.datetime.strptime(now.start_of("week").subtract(days=1).strftime("%A, %B %d, %Y"), "%a, %d %b %Y %H:%M:%S %Z")
            previous_duration = datetime.datetime.strptime(current_duration.subtract(weeks=1).strftime("%A, %B %d, %Y"), "%a, %d %b %Y %H:%M:%S %Z")
            ...
            current_duration = datetime.datetime.strptime(now.start_of("month").strftime("%A, %B %d, %Y"), "%a, %d %b %Y %H:%M:%S %Z")
            previous_duration = datetime.datetime.strptime(current_duration.subtract(months=1).strftime("%A, %B %d, %Y"), "%a, %d %b %Y %H:%M:%S %Z")
